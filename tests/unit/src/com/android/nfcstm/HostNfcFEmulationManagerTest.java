...
import com.android.nfcstm.cardemulation.HostNfcFEmulationManager;
...
public class HostNfcFEmulationManagerTest {
        ...
        Context mockContext =
                new ContextWrapper(context) {
                    ...
                    public Context createContextAsUser(
                            @NonNull UserHandle user, @CreatePackageOptions int flags) {
                        if (Build.IS_ENG) {
                        ...
                        () ->
                                mHostNfcFEmulationManager =
                                        new HostNfcFEmulationManager(
                                                mockContext, t3tIdentifiersCache));
    ...
    public void testOnEnabledForegroundNfcFServiceChanged() {
        ...
        when(componentName.getPackageName()).thenReturn("com.android.nfcstm");
        ...
        Assert.assertEquals("com.android.nfcstm", packageName);
    }
    ...
    public void testOnHostEmulationData() {
        ...
        mHostNfcFEmulationManager.onHostEmulationData("com.android.nfcstm".getBytes());
