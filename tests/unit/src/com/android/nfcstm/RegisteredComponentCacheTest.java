        ...
        mockContext =
                new ContextWrapper(context) {
                    ...
                    public Context createPackageContextAsUser(
                        ...
                        mockActivityInfo.packageName = "com.android.nfcstm";
                        ...
                        when(mockActivityInfo.loadXmlMetaData(
                                        packageManager, NfcAdapter.ACTION_TECH_DISCOVERED))
                                .thenReturn(parser);
                        resolveInfo.activityInfo = mockActivityInfo;
                        List<ResolveInfo> resolveInfoList = new ArrayList<ResolveInfo>();
                        resolveInfoList.add(resolveInfo);
                        when(packageManager.queryIntentActivitiesAsUser(
