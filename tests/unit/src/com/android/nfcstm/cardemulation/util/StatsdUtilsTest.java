...
public class StatsdUtilsTest {
    ...
    public void testGetFrameType() {
        assertThat(StatsdUtils.getFrameType(ECP_V1_PAYMENT))
                .isEqualTo(NFC_POLLING_LOOP_NOTIFICATION_REPORTED__PROPRIETARY_FRAME_TYPE__ECP_V1);

        assertThat(StatsdUtils.getFrameType(ECP_V2_TRANSIT_MBTA))
                .isEqualTo(NFC_POLLING_LOOP_NOTIFICATION_REPORTED__PROPRIETARY_FRAME_TYPE__ECP_V2);

        assertThat(StatsdUtils.getFrameType(UNKNOWN_FRAME))
                .isEqualTo(
    ...
    private static final byte[] UNKNOWN_FRAME =
            new byte[] {
                0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x41, 0x6e, 0x64, 0x72, 0x6f, 0x69, 0x64, 0x21
            };
