...
import static com.android.nfcstm.NfcDispatcher.DISPATCH_SUCCESS;
...
public final class NfcReaderConflictOccurredTest {
    ...
    public void setUp() {
        ...
        when(mockPackageManager.queryIntentActivitiesAsUser(
                        any(Intent.class), any(ResolveInfoFlags.class), any(UserHandle.class)))
                .thenReturn(constructConflictingResolveInfos());
    ...
    public void testLogReaderConflict() {
        ...
        ExtendedMockito.verify(() -> NfcStatsLog.write(NfcStatsLog.NFC_READER_CONFLICT_OCCURRED));
    }
