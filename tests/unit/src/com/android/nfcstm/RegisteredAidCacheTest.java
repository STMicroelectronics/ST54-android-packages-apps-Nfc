...
import com.android.nfcstm.cardemulation.RegisteredAidCache;
...
public class RegisteredAidCacheTest {
    ...
    public void setUp() throws Exception {
        ...
        InstrumentationRegistry.getInstrumentation()
                .runOnMainSync(
                        () ->
                                mRegisteredAidCache =
                                        new RegisteredAidCache(mockContext, routingManager));
    ...
    public void testOnPreferredForegroundServiceChanged() {
        ...
        componentName =
                new ComponentName("com.android.nfcstm", RegisteredAidCacheTest.class.getName());
