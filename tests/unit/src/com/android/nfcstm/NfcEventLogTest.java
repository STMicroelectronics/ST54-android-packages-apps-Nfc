...
import static com.android.nfcstm.NfcEventLog.FORMATTER;
...
public class NfcEventLogTest {
    ...
    public void testLogEvent() throws Exception {
        NfcEventProto.EventType eventType =
                NfcEventProto.EventType.newBuilder()
                        .setBootupState(
                                NfcEventProto.NfcBootupState.newBuilder().setEnabled(true).build())
                        .build();
        ...
        NfcEventProto.Event expectedEvent =
    ...
    public void testReadEventsFromLogFile() throws Exception {
        ...
        NfcEventProto.EventList eventList =
                NfcEventProto.EventList.newBuilder().addEvents(event).addEvents(event).build();
