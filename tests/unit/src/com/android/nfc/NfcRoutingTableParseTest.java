...
public final class NfcRoutingTableParseTest {
    ...
    public void testParseValidTechnologyEntry() {
        /**
         * set qualifier = 0x00 to indicates the routing is allowed for the power modes where it is
         * not supported
         */
    ...
    public void testParseValidAidEntry() {
        /**
         * set qualifier = 0x40 to indicates the routing is blocked for the power modes where it is
         * not supported
         */
    ...
    private byte[] generateRoutingEntry(
