...
public class NativeNfcStDtaExtensions {
    ...
    public native boolean initialize(boolean nfc_state);
    ...
    public native void setSnepMode(byte role, byte server_type, byte request_type, byte data_type, boolean disc_incorrect_len);
    
    public native int enableDiscovery(byte con_poll, byte con_listen_dep, byte con_listen_t4tp, boolean con_listen_t3tp, boolean con_listen_acm,
