...
Java_com_st_nfc_dta_mobile_NativeNfcStDtaExtensions_initialize(JNIEnv* e, 
							jobject obj, jboolean nfc_service_state) {
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf("%s: enter;", __func__);
  jboolean result;

    result = NfcStDtaExtensions::getInstance().initialize(nfc_service_state);
  return result;
}
...
/*******************************************************************************
**
** Function: Java_com_st_nfc_dta_mobile_NativeNfcStDtaExtensions_disableDiscovery
**
