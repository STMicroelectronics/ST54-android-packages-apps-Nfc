...
public class NativeNfcStExtensions {
    ...
    public native boolean connectEE();

    public native boolean disconnectEE();
    ...
    public native void sendPropSetConfig(int configSubSetId, int paramId, byte[] param, int length);

    public native byte[] sendPropGetConfig(int configSubSetId, int paramId);
