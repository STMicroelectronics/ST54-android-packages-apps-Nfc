...
public class StNativeNfcManager implements StDeviceHost {
    ...
    public StNativeNfcManager(Context context, DeviceHostListener listener,
    ...
    private void notifyDefaultRoutesSet(int aidRoute, int mifareRoute, int isoDepRoute,
            int felicaRoute, int abTechRoute, int scRoute){
        mListener.onDefaultRoutesSet(aidRoute, mifareRoute, isoDepRoute, felicaRoute, abTechRoute, scRoute);
    }
    ...
    public native boolean doSetMuteTech(boolean muteA, boolean muteB, boolean muteF, boolean isCommitNeeded);

    //NfcSettingsAdapter
    public native void setUserDefaultRoutesPref(int mifareRoute, int isoDepRoute,
            int felicaRoute, int abTechRoute, int scRoute, int aidRoute);
