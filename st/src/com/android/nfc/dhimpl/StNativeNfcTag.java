...
//            status = connectWithStatus(technologies[techIndex]);
          ...
          if((technologies[techIndex] == TagTechnology.NFC_A) && (mTechLibNfcTypes[techIndex] == 0x90)){

            Log.d(TAG, "findAndReadNdef() - skipping index " + techIndex + " because frame RF intf/MIFARE proto not supported");
