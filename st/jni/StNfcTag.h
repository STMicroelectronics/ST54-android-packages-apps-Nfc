...
class NfcTag {
 public:
  ...
  uint8_t mLptdPresenceCheckSwitch;
  uint8_t mLptdPresenceCheckNum;
  static const uint8_t LPTD_PRS_CHK_DISABLE = 0;
  static const uint8_t LPTD_PRS_CHK_DEFAULT = 4;
  ...
  *******************************************************************************/
  ...
  bool isSameTag(tNFC_RF_TECH_PARAMS rf_tech_params);
};
