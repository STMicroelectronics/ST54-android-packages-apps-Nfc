...
public:
    ...
    **
     ...
     **
     ** Description:     Create and opens a pipe (if needed) between the DH and the
     ...
     **
     *******************************************************************************/
    bool transceive(uint8_t pipeId, uint8_t hciCmd, uint16_t txBufferLength, uint8_t* txBuffer, int32_t& recvBufferActualSize, uint8_t* rxBuffer);
     ...
     **
     *******************************************************************************/
    void setProprietaryConfigSettings(int prop_config_id,int byteNb, int bitNb, bool status);
    /* NCI 2.0 - End */
    ...
    **
    *******************************************************************************/
//    void notifyTransactionListenersOfAidSelection (const uint8_t* aidBuffer, uint8_t aidBufferLen, uint8_t host_id);
    ...
    **
    *******************************************************************************/
    void notifyTransactionListenersOfTechProtoRouting (uint8_t trigger, uint8_t techproto, uint8_t host_id);
...
//    void setNfccPowerMode(int transport, int powermode);
    ...
    void sendPropSetConfig(int subSetId, int configId, uint8_t *param, uint32_t length);
    void sendPropGetConfig(int subSetId, int configId, uint8_t *param, uint16_t& length);
    void sendPropTestCmd(int subCode, uint8_t *paramTx, uint16_t lengthTx, uint8_t *paramRx, uint16_t& lengthRx);
    ...
    **
    *******************************************************************************/
     static void StVsLogsCallback (tNFC_VS_EVT event, uint16_t data_len, uint8_t* p_data);
    /*******************************************************************************
     **
...
#define MATCH_SEL_ST_CE_GOT_SELECT 3
  void StMatchSelectSw(uint8_t format, uint16_t data_len,
                                uint8_t* p_data, bool last);
  void StMatchStoreActionAid(uint8_t nfcee, uint8_t * aid, int len);
  void StMatchGotLogPartialAid(uint8_t * aidBeg, int aidBegLen,
...
#define MATCH_SEL_QUEUE_LEN 5
  ...
  uint8_t mMatchSelectedAid[16 * MATCH_SEL_QUEUE_LEN]; // received in ACTION_NTF
