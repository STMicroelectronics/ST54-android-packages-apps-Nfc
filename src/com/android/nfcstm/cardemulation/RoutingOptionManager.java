...
public class RoutingOptionManager {
    public final String TAG = "HCENfc_RoutingOptionManager";
    ...
    RoutingOptionManager() {
        ...
        if (DBG) Log.d(TAG, "mOffHostRouteUicc=" + bytesToString(mOffHostRouteUicc));
        mOffHostRouteEse = doGetOffHostEseDestination();
        if (DBG) Log.d(TAG, "mOffHostRouteEse=" + bytesToString(mOffHostRouteEse));
    ...
    public void recoverOverridedRoutingTable() {
        ...
        mOverrideDefaultRoute =
                mOverrideDefaultIsoDepRoute = mOverrideDefaultOffHostRoute = ROUTE_UNKNOWN;
    }
