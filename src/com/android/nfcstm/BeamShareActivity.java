...
public class BeamShareActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mNfcAdapter == null) {
            ...
            if (!mNfcAdapter.isEnabled()) {
                showNfcDialogAndExit(com.android.nfcstm.R.string.beam_requires_nfc_enabled);
            } else {
    ...
    private void showNfcDialogAndExit(int msgId) {
        ...
        AlertDialog.Builder dialogBuilder =
                new AlertDialog.Builder(this, com.android.nfcstm.R.style.DialogAlertDayNight);
        ...
        if (mUris.size() > 0) {
            ...
            for (Uri uri : mUris) {
                try {
                    ...
                    grantUriPermission(
                            "com.android.nfcstm", uri, Intent.FLAG_GRANT_READ_URI_PERMISSION);
