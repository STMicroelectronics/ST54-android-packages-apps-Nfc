...
public class NfcInjector {
    ...
    public NfcInjector(@NonNull Context context, @NonNull Looper mainLooper) {
        ...
        mFeatureFlags = new com.android.st.nfc.flags.FeatureFlagsImpl();
        ...
        if (manager == null) {
            Log.e(TAG, "constructor - NfcServiceManager is null");
    ...
    public StDeviceHost makeDeviceHost(
            DeviceHost.DeviceHostListener listener, NativeNfcStExtensions stExtensions) {
        return new StNativeNfcManager(mContext, listener, stExtensions);
    }
