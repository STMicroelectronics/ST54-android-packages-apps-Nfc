...
public class NfcService implements DeviceHostListener, ForegroundUtils.Callback {
    ...
    private final FeatureFlags mFeatureFlags = new com.android.st.nfc.flags.FeatureFlagsImpl();
    ...
    private boolean setPowerSavingMode(boolean flag) {
        synchronized (NfcService.this) {
            if ((flag && mState != NfcAdapter.STATE_ON)
                ...
                Log.d(
                        TAG,
                        "Enable Power Saving Mode is allowed in Nfc On state or "
    ...
    final class NfcAdapterService extends INfcAdapter.Stub {
        @Override
        public boolean enable(String dummy) throws RemoteException {
        ...
        @Override
        public boolean disable(boolean saveState, String dummy) throws RemoteException {
            NfcPermissions.enforceAdminPermissions(mContext);
