...
public class HostEmulationManager {
        ...
        synchronized (mLock) {
            ...
            if (selectAid != null) {
                ...
                if (resolvedService == null) {
                    ...
                    mState = STATE_W4_DEACTIVATE;
                    launchResolver((ArrayList<StApduServiceInfo>) resolveInfo.services, null,
    ...
    void launchResolver(ArrayList<StApduServiceInfo> services, ComponentName failedComponent,
            String category) {
    ...
    private ServiceConnection mPaymentConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            if (DBG) Log.d(TAG, "ServiceConnection(mPaymentConnection) - onServiceConnected()");
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if (DBG) Log.d(TAG, "ServiceConnection(mPaymentConnection) - onServiceDisconnected()");
            ...
            if (msg.what == HostApduService.MSG_RESPONSE_APDU) {
                ...
                synchronized (mLock) {
                    ...
                    if (resolveInfo.services.size() > 0) {
                        launchResolver((ArrayList<StApduServiceInfo>) resolveInfo.services,
