...
public class CardEmulationManager implements RegisteredServicesCache.Callback,
    ...
    boolean setDefaultServiceForCategoryChecked(int userId, ComponentName service,
        ...
        if (service != null)
            if (DBG) Log.d(TAG,
                    "setDefaultServiceForCategoryChecked() - service: " + service.flattenToString()
                            + ", category: " + category);
            else if (DBG) Log.d(TAG,
                    "setDefaultServiceForCategoryChecked() - service: null" + ", category: "
                            + category);
    ...
    final class CardEmulationInterface extends INfcCardEmulation.Stub {
        ...
        public boolean registerAidGroupForService(int userId,
            ...
            if (DBG2) Log.d(TAG, "CardEmulationInterface - registerAidGroupForService() - service: "
                    + service.flattenToString()
                    + ", aidGroup: " + aidGroup.toString());
        ...
        public boolean setOffHostForService(int userId, ComponentName service, String offHostSE) {
            ...
            if (DBG) Log.d(TAG, "CardEmulationInterface - setOffHostForService() - service: " + 
			service.flattenToString() + ", offHostSE: " + offHostSE);
        ...
        public boolean unsetOffHostForService(int userId, ComponentName service) {
            ...
            if (DBG) Log.d(TAG, "CardEmulationInterface - unsetOffHostForService() - service: " + 
			service.flattenToString());
        ...
        public AidGroup getAidGroupForService(int userId,
            ...
            if (DBG2) Log.d(TAG, "CardEmulationInterface - getAidGroupForService() - service: "
                    + service.flattenToString() + ", category: " + category);
            ...
            StAidGroup stGroup = mServiceCache.getAidGroupForService(userId, Binder.getCallingUid(),
                    service,
                    category);
        ...
        public boolean removeAidGroupForService(int userId,
            ...
            if (DBG) Log.d(TAG, "CardEmulationInterface - removeAidGroupForService() - service: "
                    + service.flattenToString() + ", category: " + category);
        ...
        public List<ApduServiceInfo> getServices(int userId, String category)
            ...
            NfcPermissions.validateUserId(userId);
            NfcPermissions.enforceAdminPermissions(mContext);
            List<StApduServiceInfo> stApduServices = mServiceCache.getStServicesForCategory(userId,
                    category);
        ...
        public ApduServiceInfo getPreferredPaymentService(int userId) throws RemoteException {
            ...
            return mServiceCache.getStService(userId, mAidCache.getPreferredService()).createApduServiceInfo();
        }
    }
    ...
    public Map<String, Integer> getServicesAidCacheSize(int userId, String category) {
        ...
        NfcPermissions.validateUserId(userId);
        NfcPermissions.enforceUserPermissions(mContext);
        nonPaymentServices = mServiceCache.getStServicesForCategory(userId,
        ...
        if (DBG) Log.d(TAG, "getServicesAidCacheSize() - nonPaymentServiceAidCacheSize: "
