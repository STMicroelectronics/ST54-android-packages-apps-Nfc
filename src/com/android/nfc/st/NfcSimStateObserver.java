...
public class NfcSimStateObserver extends BroadcastReceiver {
    ...
    static public final int STATE_ABSENT = 0;
    static public final int STATE_PRESENT_BUSY = 1;
    static public final int STATE_PRESENT_READY = 2;
    static public final int STATE_UNKNOWN = 0xff;
    static public final int PENDING_NONE = STATE_UNKNOWN;
    ...
    */
    ...
    public int GetSimState(int simId) {
        Log.d(TAG, "GetSimState simId = " + simId + ", mSim1State = " + mSim1State +
    ...
    public static void createSingleton(Context context) {
        ...
        instance.mContext.registerReceiver(instance,
                new IntentFilter(Intent.ACTION_AIRPLANE_MODE_CHANGED));

        instance.mIsAirplaneModeOn = (Settings.Global.getInt(context.getContentResolver(),
                Settings.Global.AIRPLANE_MODE_ON, 0) != 0);

        instance.mAirplaneModeHidesSims = SystemProperties.get("persist.st_nfc_modem_airplane").equals("1");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(TelephonyIntents.ACTION_SIM_STATE_CHANGED)) {
            ...
            Log.d(TAG,
                    "ACTION_AIRPLANE_MODE_CHANGED receiver, state = " + instance.mIsAirplaneModeOn
                            + ", mSimListener=" + instance.mSimListener);
        }
    }
    ...
    public interface SimEventListener {
        ...
        static public final int ABSENT = NfcSimStateObserver.STATE_ABSENT;
        static public final int PRESENT_BUSY = NfcSimStateObserver.STATE_PRESENT_BUSY;
        static public final int PRESENT_READY = NfcSimStateObserver.STATE_PRESENT_READY;
        ...
        synchronized (instance) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    NfcSimStateObserver instance = getInstance();
                    synchronized (instance) {
                        Log.d(TAG, "mPendingSim1=" + instance.mPendingSim1 + " mPendingSim2="
                                + instance.mPendingSim2 + " simListener=" + instance.mSimListener);
                        if (instance.mSimListener != null) {
                            if (instance.mPendingSim1 != PENDING_NONE) {
                                instance.mSimListener.onSimStateChanged(SimEventListener.SIM1, instance.mPendingSim1);
                                instance.mPendingSim1 = PENDING_NONE;
                            }

                            if (instance.mPendingSim2 != PENDING_NONE) {
                                instance.mSimListener.onSimStateChanged(SimEventListener.SIM2, instance.mPendingSim2);
                                instance.mPendingSim2 = PENDING_NONE;
                            }
                        }
                    }
